...
let g:which_key_map['e'] = [ ':CocCommand explorer --width 50', 'explorer' ]
let g:which_key_map['h'] = [ '<C-W>s'                             , 'split below']
let g:which_key_map['m'] = [ ':call WindowSwap#EasyWindowSwap()'  , 'move window' ]
let g:which_key_map['M'] = [ ':MaximizerToggle!'  , 'maxmizer toggle' ]
let g:which_key_map['n'] = [ ':let @/ = ""'                       , 'no highlight' ]
let g:which_key_map['p'] = [ ':Files'                             , 'search files' ]
let g:which_key_map['q'] = [ ':wa | qa'                           , 'quit' ]
...
let g:which_key_map.d = {
      ...
      \ 'a' : [':call vimspector#Continue()', 'Continue'],
      \ }

      " \ 'd' : [':call vimspector#Launch()'  , 'Start debugging'],
      "
